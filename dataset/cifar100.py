...
def get_data_folder(data_folder_dir="../data"):
    """
...
def get_cifar100_dataloaders(batch_size=128, num_workers=8, is_instance=False, data_folder_dir="../data"):
    """
    cifar 100
    """
...
def get_cifar100_dataloaders_sample(batch_size=128, num_workers=8, k=4096, mode='exact', data_folder_dir="../data",
