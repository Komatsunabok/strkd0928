...
def get_data_folder(data_folder_dir="../data", dataset='imagenet'):
    """
    return the path to store the data
    """
    data_folder = os.path.join(data_folder_dir, dataset)
...
def get_test_loader(dataset='imagenet', batch_size=128, num_workers=8, data_folder_dir="../data"):
    """get the test data loader"""

    if dataset == 'imagenet':
        data_folder = get_data_folder(data_folder_dir, dataset)
    else:
...
def get_dataloader_sample(dataset='imagenet', batch_size=128, num_workers=8, data_folder_dir="../data",
...
def get_imagenet_dataloader(dataset='imagenet', batch_size=128, num_workers=16, data_folder_dir="../data",
