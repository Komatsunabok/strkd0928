...
echo "=== Start ==="
python train_student.py --dataset cifar100 --model vgg16_bn_half --model_t vgg16_bn --beta 100 --beta_method fixed \
...
echo "=== Start ==="
python train_student.py --dataset cifar100 --model vgg16_bn_half --model_t vgg16_bn --beta 200 --beta_method epoch_based \
  --model_name_t vgg16_bn-cifar100-trial_0-epochs_240-bs_64-20251014_162623 \
  --distill ckad --group_num 6 --layer_usage all --log_cka 
echo "=== Done ==="
sleep 5  # GPUメモリ開放のため5秒待機（任意）
