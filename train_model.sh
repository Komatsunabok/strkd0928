...
echo "=== Start ==="
python train_student.py --dataset cifar100 --model vgg16_bn_half --model_t vgg16_bn -c 1 -d 1 -b 1 --beta_method fixed \
  --model_name_t vgg16_bn-cifar100-trial_0-epochs_240-bs_64-20251014_162623 \
...
echo "=== Start ==="
python train_student.py --dataset cifar100 --model vgg8_bn --model_t vgg16_bn -c 1 -d 1 -b 1 --beta_method fixed \
  --model_name_t vgg16_bn-cifar100-trial_0-epochs_240-bs_64-20251014_162623 \
  --distill hint --log_cka
echo "=== Done ==="
sleep 5  # GPUメモリ開放のため5秒待機（任意）
